...
class TwoHeadDCNN(nn.Module):
    def __init__(
            ...
            deconv_output_output_padding=0
    ):
        assert len(kernel_sizes) == \
               len(n_channels) == \
               len(strides) == \
        ...
        for out_channels, kernel_size, stride, padding, outp_padding in \
        ...
        self.first_deconv_output = nn.ConvTranspose2d(
            ...
            padding=deconv_output_padding,
            output_padding=deconv_output_output_padding
        )

...
class SharedObsDictRelabelingMultiObjectBuffer(ObsDictRelabelingMultiObjectBuffer, SharedObsDictRelabelingBuffer):
    """
    The same as SharedObsDictRelabelingBuffer but for MultiObjectBuffer
    """
